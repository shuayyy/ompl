...
NB_MODULE(_ompl, m)
{
    ...
    ompl::binding::base::initSpaces_CovarianceStateSpace(base);
    ompl::binding::base::initSpaces_SE2StateSpace(base);
    ompl::binding::base::initSpaces_SE2BeliefStateSpace(base);
    ...
    ompl::binding::control::init_LieGroup(control);
    ...
    ompl::binding::control::init_SE2Propagator(control);
